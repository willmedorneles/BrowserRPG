...
export class Armor{
    constructor(name: string, attackArmorBonus: number){
        this.name = name;
        this.attackArmorBonus = attackArmorBonus;
    }

    name: string;
    attackArmorBonus: number;
}
...
export class Hero extends BaseCharacter {
    ...
    equipNewArmor(armor: Armor): void {
        if(this.equippedArmor){
            this.barriers.attack -= this.equippedArmor.attackArmorBonus;
        }
        this.equippedArmor = armor;
        this.barriers.attack += armor.attackArmorBonus;
    }
...
export class Cleric extends Hero {
    constructor(name, gender, race, level, health, skills, weapon, armor){
        ...
        this.skills.sneak--;
        this.skills.attack--;
        this.spriteUrl = this.gender === GenderOptions.male ? "../assets/cleric.png":"../assets/cleric.png";
    }
